...
const xeroContentTypesData = [
  {
    ...
    "voiceGuidance": "Start by acknowledging the reader's situation in plain language, then quickly move to practical steps or insights. Use short paragraphs, clear subheadings and bulleted lists to make scanning easy. Avoid accounting jargon or, if it's needed, define it in simple terms. Use examples from everyday business life. Emphasise outcomes like time saved, reduced stress, better visibility and confidence.",
    "examples": [
      {
  ...
  },
  {
    ...
    "voiceGuidance": "Focus on topics like workflow efficiency, client collaboration, compliance changes, advisory services and using Xero and connected apps to deliver more value to clients. Show empathy for their time pressures and the need to adopt new technology while running a busy practice. Balance strategic insight with practical examples. Tone is confident, collegial and practical.",
    "examples": [
      {
  ...
  },
  {
    ...
    "voiceGuidance": "Keep the tone practical and helpful. Use short sections and bullets to cover: what's new, what it means for the customer, where and when it's available (including regional differences), and what they need to do to start using it. Avoid over-promising or hype. If there are limitations or phased rollouts, state them plainly. Use consistent naming and correct capitalisation for Xero products and features.",
    "examples": [
      {
  ...
  },
  {
    ...
    "voiceGuidance": "Lead with the most important finding or pattern in the data and why it matters for small businesses, policymakers or advisors. Use charts and simple explanations to make trends easy to grasp. Explain any technical terms in plain language. Always clarify that insights are general, not personal financial advice. Attribute data appropriately and link to full reports or methodology for readers who want more detail.",
    "examples": [
      {
